...
export default function ProposalVoteModal({
  ...
  const winningOption = () => {
    if (forPercentage > againstPercentage && forPercentage > abstainPercentage)
      return "For";
    if (
      againstPercentage > forPercentage &&
      againstPercentage > abstainPercentage
    )
      return "Against";
    if (
      abstainPercentage > forPercentage &&
      abstainPercentage > againstPercentage
    )
      return "Abstain";
    return "Tied";
  };
                ...
                <div className="p-6 sm:p-8">
                  ...
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-purple-300">
                      Cast your vote to participate in DAO governance
                    </p>
                  </div>
                  ...
                  <div className="space-y-6 max-h-[60vh] overflow-y-auto pr-2">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-700/30 backdrop-blur-sm rounded-lg p-3 border border-slate-600/50">
                        <span className="text-xs font-medium text-purple-300 block mb-1">
                          Proposal ID
                        </span>
                      ...
                      <div className="bg-slate-700/30 backdrop-blur-sm rounded-lg p-3 border border-slate-600/50">
                        ...
                        <span className="text-white text-xs">
                          {formatDate(
                            new Date(Number(proposal.voteEnd) * 1000),
                          )}
                        </span>
                      </div>
                          ...
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="flex items-baseline gap-2">
                              ...
                              <span className="text-sm text-slate-400">
                                ({formatBigInt(proposal.forVotes)} votes)
                              </span>
                            </div>
                          </div>
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="flex items-baseline gap-2">
                              ...
                              <span className="text-sm text-slate-400">
                                ({formatBigInt(proposal.againstVotes)} votes)
                              </span>
                            </div>
                          </div>
                          <div className="w-full bg-slate-700 rounded-full h-3 overflow-hidden">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="flex items-baseline gap-2">
                              ...
                              <span className="text-sm text-slate-400">
                                ({formatBigInt(proposal.abstainVotes)} votes)
                              </span>
                            </div>
                          </div>
                          <div className="w-full bg-slate-700 rounded-full h-3 overflow-hidden">
